...
const MOVIE_API_URL = `http://api.themoviedb.org/3/movie/top_rated?api_key=${MOVIE_API_KEY}`;
const TV_API_URL = `http://api.themoviedb.org/3/tv/popular?api_key=${MOVIE_API_KEY}`;
...
const MUSIC_API_URL = `http://ws.audioscrobbler.com/2.0/?method=chart.gettoptracks&api_key=${MUSIC_API_KEY}&format=json`;
